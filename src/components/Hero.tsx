...
export const Hero: React.FC = () => {
  ...
  return (
    <section
      id="hero"
      className="relative pt-28 pb-16 md:pt-36 md:pb-24 lg:pt-40 lg:pb-28 bg-[#fafbfc] overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left">
            ...
            >
              Motion Designer & Brand Identity Specialist
            </p>
            ...
            >
              Transforming complex brand stories into unforgettable motion graphics, timeless visual identity systems, and high-impact commercial animations that drive engagement.
            </p>
            ...
            >
              ...
              <div>
                <div className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">8+</div>
                <div className="text-xs text-slate-500 font-medium mt-0.5">Years Experience</div>
              </div>
              <div>
                <div className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">45+</div>
                <div className="text-xs text-slate-500 font-medium mt-0.5">Brand Marks</div>
              </div>
            </div>
          </div>
